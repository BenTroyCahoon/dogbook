...
//     const fetchDogImage = async () => {    try {      const response = await axios.get('https://dog.ceo/api/breeds/image/random');      return response.data.message; // Return the URL of the random dog image
//    } catch (error) {
...
//     try {
//         const response = await axios.delete(`http://localhost:3000/dogs/${idToRemove}`);
//         if (response.status === 200) {
//             // Assuming setDogs is defined in the component where removeDog is used
